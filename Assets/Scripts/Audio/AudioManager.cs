...
public class AudioManager : MonoBehaviour
{
    ...
    [Range(0f, 1f)] public float bgmVolume = 0.15f;
    ...
    private void Awake()
    {
        ...
        // PlayerPrefsから音量設定を読み込む（デフォルト: BGM 15%, SE 70%）
        bgmVolume = PlayerPrefs.GetFloat("BGMVolume", 0.15f);
        ...
        if (seSource != null)
        {
            seSource.volume = 1f; // PlayOneShotのvolumeScaleで音量制御するため1固定
        }
    }
    ...
    public void SetSEVolume(float volume)
    {
        ...
        // seSource.volumeは1固定。PlayOneShotのvolumeScaleパラメータで音量を制御する。
    }
